<template>
  <div>
    ...
    <b-modal v-model="showModal" title="Nueva película" hide-footer size="xl">
          ...
          <div class="info-column">
            ...
            >
              <b-form-input
                ...
                v-model="publishDate"
                type="text"
                placeholder="Fecha de publicación de la película (YYYY-MM-DD)"
                required
              ></b-form-input>
            </b-form-group>
